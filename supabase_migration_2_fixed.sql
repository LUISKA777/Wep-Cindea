...
-- VERSION CORREGIDA: Evita subconsultas en columnas generadas
-- ============================================================
...
-- 4. Create grades table (WITHOUT generated column that uses subquery)
CREATE TABLE IF NOT EXISTS grades (
  id SERIAL PRIMARY KEY,
  student_subject_id INTEGER REFERENCES student_subjects(id) ON DELETE CASCADE,
  final_grade DECIMAL(5,2),
  passed BOOLEAN DEFAULT FALSE,  -- Will be set by application logic
...
--
-- NOTA: La columna 'passed' ahora se establece en la aplicación (rutas de profesor)
-- ============================================================